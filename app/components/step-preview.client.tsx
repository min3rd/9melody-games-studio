...
export default function StepPreview(): React.ReactElement {
  ...
  const snippetCode = `import { Step } from '@/components/ui';\n\n<Step index={1} label="Step One" description="Start here" />`;
  ...
  return (
    <PreviewLayout title="Step" preview={preview} controls={controls} snippet={snippet} />
  );
}
